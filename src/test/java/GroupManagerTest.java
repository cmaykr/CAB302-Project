...
public class GroupManagerTest {
    ...
    @BeforeEach
    void setUp() {
        groupManager = new GroupManager(new MockGroupDAO(), new MockCategoryDAO(), new MockViewUserDAO());
        GroupManager g = new GroupManager(new SqliteGroupDAO(), new SqliteCategoryDAO(), new SqliteViewUserDAO());
    }
